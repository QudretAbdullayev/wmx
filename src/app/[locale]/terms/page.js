...
export default async function Page({ params }) {
    ...
    rules: [
      {
        ...
        description: `<h1>Privacy Policy</h1><br>
          ...
          <p>We collect and process your personal information only with your knowledge and consent. This typically happens when you:<br>
  ...
  return <RulesPage data={data} activeIndex={1} links={links} />;
}
