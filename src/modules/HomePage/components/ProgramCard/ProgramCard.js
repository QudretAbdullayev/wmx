  ...
  return (
    <EffectCard>
      ...
      >
        ...
        <div
          className={`${styles.card__container} ${data.lock ? styles.card__lock : ""
            }`}
        >
          <div className={styles.card__detail}>
            ...
            <div className={`${styles.program} ${styles.program_lock}`}>
              <span
                className={`${styles.program__title} ${data.lock ? styles.program__program_title : ""
                  }`}
              >
                {data.title}
              </span>
            ...
            <div className={styles.content}>
              <h3
                className={`${styles.content__title} ${data.lock ? styles.content__lock_title : ""
                  }`}
              >
                {data.subtitle}
              </h3>
              <p
                className={`${styles.content__desc} ${data.lock ? styles.content__lock_desc : ""
                  }`}
              >
                {data.description}
              </p>
